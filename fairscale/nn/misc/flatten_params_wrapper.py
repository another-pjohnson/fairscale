...
class FlattenParamsWrapper(nn.Module):
    ...
    def __init__(self, module: nn.Module, param_list: ParamGroups = None, flat_param_names: Optional[List[str]] = None, ssd_offload: bool = False, ssd_directory: str = ""):
        super().__init__()
